...
public class BebeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // Retrieve the Bebe object from the Firebase database
        bebe = new Bebe();  // Default Bebe object, could be fetched from Firebase
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // Set onClickListeners for each button (reset timers)
        ...
        // Resume each timer from Firebase (or initialize if null)
    ...
    private void showResetDialog(EditText editText, String key, String nom) {
        new AlertDialog.Builder(getContext())
                ...
                .setPositiveButton("Oui", (dialog, which) -> {
                    // Reset the corresponding value in the Bebe object and update Firebase
                    resetBebeValue(key);
