    ...
    private void showResetDialog(EditText editText, String key) {
        new AlertDialog.Builder(getContext())
                ...
                .setPositiveButton("Oui", (dialog, which) -> {
                    ...
                    int currentTabIndex = ((BebeFragment) getParentFragment()).getCurrentTabIndex();
                    ...
                    bebeManager.setValue(chmp, key, currentTime, new BebeManager.UpdateValueCallback() {
                        ...
                        public void onSuccess() {
                            ...
                            // Rétablir l'onglet après la mise à jour
                            ((BebeFragment) getParentFragment()).setCurrentTabIndex(currentTabIndex);
                        }
