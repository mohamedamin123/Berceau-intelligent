...
const api = axios.create({
    baseURL: `${API_URL}/sons`, // Modifier l'URL pour correspondre à l'API DHT
...
export const saveSon = async (berceauId, son) => {
    try {
        const response = await api.post('/', { berceauId, son });
...
export const getSon = async (berceauId) => {
    try {
